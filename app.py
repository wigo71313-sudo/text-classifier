...
_REFRIGERATED_PATTERN_1 = "(?<!\\d)2\\s*-\\s*8(?!\\d)"
_REFRIGERATED_PATTERN_2 = "(?<!\\d)\\+?\\s*2\\s*C?\\s*(?:TO|-)\\s*\\+?\\s*8\\s*C?(?!\\d)"
_REFRIGERATED_PATTERNS = _REFRIGERATED_PATTERN_1 + "\n" + _REFRIGERATED_PATTERN_2

DEFAULT_RULES = [
    {"name": "常溫保存", "keywords": "KEEP COOL", "patterns": ""},
    {"name": "冷藏保存", "keywords": "REFRIGERATED", "patterns": _REFRIGERATED_PATTERNS},
    {"name": "冷凍保存", "keywords": "KEEP FROZEN", "patterns": ""},
    {"name": "常溫保存_溫度範圍(15-25)", "keywords": "", "patterns": "(?<!\\d)15\\s*-\\s*25(?!\\d)"},
]
